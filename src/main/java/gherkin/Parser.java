...
public class Parser<T> {
    ...
    private Token readToken(ParserContext context) {
        return context.tokenQueue.size() > 0
                ? context.tokenQueue.remove() : context.tokenScanner.read();
    }
    ...
    private int matchTokenAt_0(Token token, ParserContext context) {
        ...
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF",
    ...
    private int matchTokenAt_1(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 1 "
                + "- GherkinDocument:0>Feature:0>Feature_Header:0>#Language:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#TagLine",
                "#FeatureLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    private int matchTokenAt_3(Token token, ParserContext context) {
        ...
        List<String> expectedTokens =
                java.util.Arrays.asList("#EOF", "#Empty",
                        "#Comment", "#BackgroundLine",
                        "#TagLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    // GherkinDocument:0>Feature:0>Feature_Header:3>
    // Feature_Description:0>Description_Helper:1>Description:0>#Other:0
    private int matchTokenAt_4(Token token, ParserContext context) {
        ...
        final String stateComment =
                "State: 4 - GherkinDocument:0>Feature:0>"
                        + "Feature_Header:3>Feature_Description:0>"
                        + "Description_Helper:1>Description:0>#Other:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF",
                "#Comment", "#BackgroundLine",
                "#TagLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Other");
    ...
    // GherkinDocument:0>Feature:0>
    // Feature_Header:3>Feature_Description:0>Description_Helper:2>#Comment:0
    private int matchTokenAt_5(Token token, ParserContext context) {
        ...
        final String stateComment =
                "State: 5 - GherkinDocument:0>Feature:0>"
                        + "Feature_Header:3>Feature_Description:0>Description_Helper:2>#Comment:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF",
                "#Comment", "#BackgroundLine", "#TagLine",
                "#ScenarioLine", "#ScenarioOutlineLine", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    // GherkinDocument:0>Feature:1>Background:1>Background_Description:0>Description_Helper:1
    ...
    private int matchTokenAt_7(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 7 - "
                + "GherkinDocument:0>Feature:1>Background:1>Background_Description:0"
                + ">Description_Helper:1>Description:0>#Other:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Comment", "#StepLine",
                "#TagLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    // GherkinDocument:0>Feature:1>Background:1>Background_Description:0>Description_Helper:2
    // >#Comment:0
    private int matchTokenAt_8(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 8 - "
                + "GherkinDocument:0>Feature:1>Background:1>Background_Description:0>Description_Helper"
                + ":2>#Comment:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Comment", "#StepLine",
                "#TagLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    private int matchTokenAt_9(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 9 - "
                + "GherkinDocument:0>Feature:1>Background:2>Scenario_Step:0>Step:0>#StepLine:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#TableRow",
                "#DocStringSeparator", "#StepLine", "#TagLine", "#ScenarioLine",
                "#ScenarioOutlineLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    // GherkinDocument:0>Feature:1>Background:2>Scenario_Step:0>Step:1>Step_Arg:0>__alt1:0
    ...
    private int matchTokenAt_10(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 10 - "
                + "GherkinDocument:0>Feature:1>Background:2>Scenario_Step:0>Step:1>Step_Arg:0>__alt1"
                + ":0>DataTable:0>#TableRow:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#TableRow", "#StepLine",
    ...
    private int matchTokenAt_11(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 11 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:0>Tags:0>#TagLine:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#TagLine", "#ScenarioLine",
                "#ScenarioOutlineLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_12(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 12 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:0"
                + ">#ScenarioLine:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Empty", "#Comment",
                "#StepLine", "#TagLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:1>Scenario_Description
    ...
    private int matchTokenAt_13(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 13 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:1"
                + ">Scenario_Description:0>Description_Helper:1>Description:0>#Other:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Comment", "#StepLine",
                "#TagLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Other");
        ParserException error = token.isEOF()
    ...
    private int matchTokenAt_14(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 14 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:1"
                + ">Scenario_Description:0>Description_Helper:2>#Comment:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Comment", "#StepLine",
                "#TagLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Empty");
        ParserException error = token.isEOF()
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:2>Scenario_Step:0>Step
    // :0>#StepLine:0
    private int matchTokenAt_15(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 15 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:2>Scenario_Step"
                + ":0>Step:0>#StepLine:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#TableRow",
                "#DocStringSeparator", "#StepLine", "#TagLine", "#ScenarioLine",
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:2>Scenario_Step:0>Step
    // :1>Step_Arg:0>__alt1:0>DataTable:0>#TableRow:0
    private int matchTokenAt_16(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 16 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:2>Scenario_Step"
                + ":0>Step:1>Step_Arg:0>__alt1:0>DataTable:0>#TableRow:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#TableRow", "#StepLine",
                "#TagLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:0
    ...
    private int matchTokenAt_17(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 17 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:0"
                + ">#ScenarioOutlineLine:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Empty", "#Comment",
                "#StepLine", "#TagLine", "#ExamplesLine", "#ScenarioLine", "#ScenarioOutlineLine",
                "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:1
    // >ScenarioOutline_Description:0>Description_Helper:1>Description:0>#Other:0
    private int matchTokenAt_18(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 18 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:1"
                + ">ScenarioOutline_Description:0>Description_Helper:1>Description:0>#Other:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Comment", "#StepLine",
                "#TagLine", "#ExamplesLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    private int matchTokenAt_19(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 19 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:1"
                + ">ScenarioOutline_Description:0>Description_Helper:2>#Comment:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Comment", "#StepLine",
                "#TagLine", "#ExamplesLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:2
    ...
    private int matchTokenAt_20(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 20 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:2"
                + ">ScenarioOutline_Step:0>Step:0>#StepLine:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#TableRow",
                "#DocStringSeparator", "#StepLine", "#TagLine", "#ExamplesLine", "#ScenarioLine",
                "#ScenarioOutlineLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:2
    // >ScenarioOutline_Step:0>Step:1>Step_Arg:0>__alt1:0>DataTable:0>#TableRow:0
    private int matchTokenAt_21(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 21 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:2"
                + ">ScenarioOutline_Step:0>Step:1>Step_Arg:0>__alt1:0>DataTable:0>#TableRow:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#TableRow", "#StepLine",
                "#TagLine", "#ExamplesLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Comment",
                "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:3
    ...
    private int matchTokenAt_22(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 22 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:3"
                + ">Examples_Definition:0>Tags:0>#TagLine:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#TagLine", "#ExamplesLine",
                "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_23(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 23 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:3"
                + ">Examples_Definition:1>Examples:0>#ExamplesLine:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Empty", "#Comment",
                "#TableRow", "#TagLine", "#ExamplesLine", "#ScenarioLine", "#ScenarioOutlineLine",
                "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:3
    // >Examples_Definition:1>Examples:1>Examples_Description:0>Description_Helper:1>Description
    // :0>#Other:0
    private int matchTokenAt_24(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 24 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:3"
                + ">Examples_Definition:1>Examples:1>Examples_Description:0>Description_Helper:1"
                + ">Description:0>#Other:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Comment", "#TableRow",
                "#TagLine", "#ExamplesLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:3
    // >Examples_Definition:1>Examples:1>Examples_Description:0>Description_Helper:2>#Comment:0
    private int matchTokenAt_25(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 25 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:3"
                + ">Examples_Definition:1>Examples:1>Examples_Description:0>Description_Helper:2"
                + ">#Comment:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#Comment", "#TableRow",
                "#TagLine", "#ExamplesLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Empty");
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:3
    // >Examples_Definition:1>Examples:2>Examples_Table:0>#TableRow:0
    private int matchTokenAt_26(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 26 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:3"
                + ">Examples_Definition:1>Examples:2>Examples_Table:0>#TableRow:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#TableRow", "#TagLine",
                "#ExamplesLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:2
    // >ScenarioOutline_Step:0>Step:1>Step_Arg:0>__alt1:1>DocString:0>#DocStringSeparator:0
    private int matchTokenAt_28(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 28 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:2"
                + ">ScenarioOutline_Step:0>Step:1>Step_Arg:0>__alt1:1>DocString:0>#DocStringSeparator"
                + ":0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#DocStringSeparator", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:2
    // >ScenarioOutline_Step:0>Step:1>Step_Arg:0>__alt1:1>DocString:2>#DocStringSeparator:0
    private int matchTokenAt_29(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 29 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:1>ScenarioOutline:2"
                + ">ScenarioOutline_Step:0>Step:1>Step_Arg:0>__alt1:1>DocString:2>#DocStringSeparator"
                + ":0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#StepLine", "#TagLine",
                "#ExamplesLine", "#ScenarioLine", "#ScenarioOutlineLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:2>Scenario_Step:0>Step
    // :1>Step_Arg:0>__alt1:1>DocString:0>#DocStringSeparator:0
    private int matchTokenAt_30(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 30 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:2>Scenario_Step"
                + ":0>Step:1>Step_Arg:0>__alt1:1>DocString:0>#DocStringSeparator:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#DocStringSeparator", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
    ...
    // GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:2>Scenario_Step:0>Step
    // :1>Step_Arg:0>__alt1:1>DocString:2>#DocStringSeparator:0
    private int matchTokenAt_31(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 31 - "
                + "GherkinDocument:0>Feature:2>Scenario_Definition:1>__alt0:0>Scenario:2>Scenario_Step"
                + ":0>Step:1>Step_Arg:0>__alt1:1>DocString:2>#DocStringSeparator:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#StepLine", "#TagLine",
                "#ScenarioLine", "#ScenarioOutlineLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
        if (stopAtFirstError) {
    ...
    // GherkinDocument:0>Feature:1>Background:2>Scenario_Step:0>Step:1>Step_Arg:0>__alt1:1
    ...
    private int matchTokenAt_32(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 32 - "
                + "GherkinDocument:0>Feature:1>Background:2>Scenario_Step:0>Step:1>Step_Arg:0>__alt1:1"
                + ">DocString:0>#DocStringSeparator:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#DocStringSeparator", "#Other");
    ...
    private int matchTokenAt_33(Token token, ParserContext context) {
        ...
        final String stateComment = "State: 33 - "
                + "GherkinDocument:0>Feature:1>Background:2>Scenario_Step:0>Step:1>Step_Arg:0>__alt1:1"
                + ">DocString:2>#DocStringSeparator:0";
        token.detach();
        List<String> expectedTokens = java.util.Arrays.asList("#EOF", "#StepLine", "#TagLine",
    ...
    public enum RuleType {
        ...
        ScenarioOutline, // ScenarioOutline! := #ScenarioOutlineLine
        // ScenarioOutline_Description ScenarioOutline_Step* Examples_Definition*
        Examples_Definition, // Examples_Definition!
    ...
    class ParserContext {
        ...
        ParserContext(ITokenScanner tokenScanner,
                      ITokenMatcher tokenMatcher,
                      Queue<Token> tokenQueue, List<ParserException> errors) {
